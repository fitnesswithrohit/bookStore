...
function Signup() {
    ...
    const onSubmit = async(data) => {
        ...
        await axios.post("https://book-store-kappa-khaki.vercel.app/", userInfo)
        .then((res)=>{ 
                    ...
                    <div className="modal-box bg-white text-black">
                        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                            ...
                            <div className='mt-4 space-y-2'>
                                <span>Name</span>
                                <br />
                                <input type="text" placeholder='Enter your Name' className='w-80 px-3 py-1 border rounded-md outline-none bg-white' {...register("fullname", { required: true })} />
